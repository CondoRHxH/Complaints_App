                                                                    ...
                                                                    <div class="flex items-center ml-3 gap-x-2">
                                                                        <div>
                                                                            <h2 class="font-medium text-gray-800 ">
                                                                                {{ $reclamer->etudiantsPrenom }}</h2>
                                                                            <p class="text-sm font-normal text-gray-600">
                                                                                {{ $reclamer->etudiantsNom }}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                ...
                                                                {{-- <div class="flex items-center gap-x-6">
                                                                    <div x-data="{ isOpen: false }"
                                                                        ...
                                                                        <div x-show="isOpen"
                                                                            ...
                                                                            class="fixed inset-0 z-10 overflow-y-auto black-overlay"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div>
                                                                                        <div
                                                                                            ...
                                                                                            <i
                                                                                                class="fas fa-info-circle text-blue-500"></i>
                                                                                        </div>
                                                                                        <div class="mt-2 text-center">
                                                                                            <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize "
                                                                                                id="modal-title">
                                                                                                {{ $reclamer->etudiantsPrenom }}
                                                                                                {{ $reclamer->etudiantsNom }}
                                                                                            </h3>
                                                                                            <p
                                                                                                class="mt-2 text-sm border-2 text-gray-500 ">
                                                                                    ...
                                                                                    <div
                                                                                        ...
                                                                                        <button @click="isOpen = false"
                                                                                            class="w-full px-4 py-2 mt-1 text-sm font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:mt-0 sm:w-auto sm:mx-2 hover:bg-gray-100 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-40">
                                                                                            Cancel
                                                                                        </button>
